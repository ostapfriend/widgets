interface CompanyI {
  ...
  cik: string;
  latest_filing_date: string | Date;
  hq_state: string;
  hq_country: string;
  inc_state: string;
  inc_country: string;
  ...
  first_fundamental_date: string | Date;
  last_fundamental_date: string | Date;
  first_stock_price_date: string | Date;
  last_stock_price_date: string | Date;
